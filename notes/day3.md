...
Completed Unit 2 (Libraries & Frameworks) with hands-on problem solving and a real-world Python mini project. Also handled practical issues like file paths and encoding on Windows.
...
* Handled Unicode encoding issues on Windows using UTF-8

### 6. Real-World Debugging Skills

* Fixed `FileNotFoundError` by understanding working directories
* Fixed `UnicodeEncodeError` by enforcing UTF-8 encoding
* Understood platform differences (Windows vs Linux)

---

## Key Takeaways

* Python standard library is powerful enough for real applications
* Environment issues are as important as logic
* Writing robust, portable code is a backend developer skill
* Unit 2 outcomes (CO2 + CO6) are fully demonstrated
